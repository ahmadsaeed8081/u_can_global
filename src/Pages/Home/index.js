...
const Main = (props) => {
  ...
  const packages_price = [100,500,1000,3000,5000,10000,20000,50000,75000,100000];
  ...
  async function getData() {
    ...
    try {
      ...
      let is_reg;
       is_reg = await props.contract.methods.isRegister(props.address.toString()).call();


      let user_id = await props.contract.methods.addresstoId(props.address).call();
      console.log("object6");

      let upliner = await props.contract.methods.uplinerOf(props.address).call();
      console.log("object7");
      ...
      try{
        total_earning_withdrawabl = await props.contract.methods.total_earning_withdrawable().call({from: props.address.toString()});
      ...
      try{
        ...
        let users = await props.contract.methods
        .user(props.address)
        .call();
        set_user(users)
  ...
  async function Upgrade_package(_package) {
    try{
      let IsPackageBought = await props.contract.methods.IsPackageBought(props.address,_package).call();

      if(IsPackageBought || curr_package > _package || !props.isWalletConnected)
      {
        return;
      }
  ...
  async function handleWithdraw(amount) {
    ...
    try{
     ...
     if(time>0)
     {
      ...
      if((Number(withdrawable_earning) - Number(user.total_withdraw)) <= 0 || (Number(withdrawable_earning) - Number(total_withdraw)) < amount)
      {
            ...
            <div className="reports-grid">
              <div className="grid-box flex flex-col">
                ...
                <div className="box-btm flex flex-col">
                  ...
                  <div className="amount">${Number(withdrawable_earning)/10**6}</div>
                </div>
              </div>
              <div className="grid-box flex flex-col">
                <div className="box-top flex items-center">
              ...
              <div className="grid-box flex flex-col">
                ...
                <div className="box-btm flex flex-col">
                  ...
                  <div className="amount">${(Number(withdrawable_earning)-Number(user.total_withdraw)/10**6)}</div>
                </div>
              </div>
              <div className="grid-box flex flex-col">
                <div className="box-top flex items-center">
              ...
              <div className="grid-box flex flex-col">
                ...
                <div className="box-btm flex flex-col">
                  ...
                  <div className="flex items-center">
                    <div className="amount">{response.firstName!=""?response.firstName:("unknown")}</div>
                    {
              ...
              <div className="grid-box flex flex-col">
                ...
                <div className="box-btm flex flex-col">
                  ...
                  <div className="amount">${Number(user.personal_group_volume)/10 ** 6}</div>
                </div>
              </div>
              <div className="grid-box flex flex-col">
                <div className="box-top flex items-center">
                ...
                <div className="box-btm flex flex-col">
                  ...
                  <div className="amount">${Number(user.personal_volume)/10 ** 6}</div>
                </div>
              </div>
              <div className="grid-box flex flex-col">
                <div className="box-top flex items-center">
                ...
                <div className="box-btm flex flex-col">
                  ...
                  <div className="amount">{Number(user.total_right_members)}</div>
                </div>
              </div>
              <div className="grid-box flex flex-col">
                <div className="box-top flex items-center">
                ...
                <div className="box-btm flex flex-col">
                  ...
                  <div className="amount">{Number(user.total_left_members)}</div>
                </div>
              </div>
              <div className="grid-box flex flex-col">
                <div className="box-top flex items-center">
